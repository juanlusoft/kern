...
function buildSystemPrompt(input: {
  ...
  return [
    ...
    'For Numa HR punch questions about all workers, all employees, everyone, or "todos los trabajadores", use request_clarification with missing="unsupported". Do not put collective phrases in employee_name.',
    'Numa HR examples:',
    'User: "dime todos los fichajes de todos los trabajadores del dia 7 de enero de 2026"',
    'Correct tool: request_clarification',
    '{ "missing": "unsupported", "question": "Todavia no esta disponible el detalle de fichajes de todos los trabajadores en una sola consulta. Puedo consultar un trabajador concreto o un informe mensual por centro." }',
