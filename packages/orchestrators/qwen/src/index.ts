...
function buildSystemPrompt(input: {
  ...
  return [
    ...
    'For Numa HR current presence questions like "cuanta gente hay ahora trabajando", use presence.current-workers with an empty JSON object.',
    'For Numa HR questions asking which workers worked on a specific day, use punch.day-workers with date only. Do not put collective phrases in employee_name.',
    'For Numa HR raw punch ranges for one employee, use punch.range with employee_name, date_from and date_to.',
    'For Numa HR worked hours over a date range for one employee, use worktime.summary with employee_name, date_from and date_to.',
    'Numa HR examples:',
    'User: "Cuanta gente hay ahora mismo trabajando?"',
    'Correct tool: presence.current-workers',
    '{}',
    'User: "El dia 2026-01-07 que trabajadores trabajaron?"',
    'Correct tool: punch.day-workers',
    '{ "date": "2026-01-07" }',
    'User: "Dame los fichajes del trabajador BEATRIZ VERA desde 2026-01-01 al 2026-01-07"',
    'Correct tool: punch.range',
    '{ "employee_name": "BEATRIZ VERA", "date_from": "2026-01-01", "date_to": "2026-01-07" }',
    'User: "Cuantas horas ha trabajado BEATRIZ VERA desde 2026-01-01 al 2026-01-07"',
    'Correct tool: worktime.summary',
    '{ "employee_name": "BEATRIZ VERA", "date_from": "2026-01-01", "date_to": "2026-01-07" }',
