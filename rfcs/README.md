...
| [RFC-0008](RFC-0008-core-runtime-turn-lifecycle-and-state-model.md) | Core Runtime, Turn Lifecycle and State Model | Draft | 2026-06-27 | Define el contrato lógico del Runtime de Kern, el ciclo de vida de Turns y la coordinación con los controles de ejecución gobernada. |
