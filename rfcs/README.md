...
| [RFC-0007](RFC-0007-decision-binding-enforcement-evidence.md) | Decision Binding, Enforcement Evidence and Runtime Verification | Draft | 2026-06-27 | Define la evidencia mínima para verificar en tiempo de efecto que una operación corresponde a un Decision Binding válido, fresco y consumible. |
