...
4. **(archivo) Corregir la corrupción de codificación UTF-8 (mojibake "Ã³", "Ã©"...) en §1-4, 6-8, 12, 14-16, 18-19.** Un documento normativo con texto corrupto arriesga ambigüedad. **ALTO** (higiene documental antes de establecer).
